...
public class Autos {
    ...
    public Command startCenterThenH() {
        return new TrajectoryBuilder(autoFactory.newRoutine("Mid->H"))
    ...
    public Command start1ThenL() {
        return new TrajectoryBuilder(autoFactory.newRoutine("L"))
            .setFlipped(flippedHorizontally)
    ...
    public Command start3TThenI() {
        return new TrajectoryBuilder(autoFactory.newRoutine("I"))
            .setFlipped(flippedHorizontally)
    ...
    public Command startThenJKLA(StartPosition startPosition) {
        ...
        return new TrajectoryBuilder(autoFactory.newRoutine("JKLA"))
            .setFlipped(flippedHorizontally)
    ...
    public Command start6ThenF() {
        return new TrajectoryBuilder(autoFactory.newRoutine("F"))
            .setFlipped(flippedHorizontally)
    ...
    public Command startLowThenGFED(StartPosition startPosition) {
        ...
        return new TrajectoryBuilder(autoFactory.newRoutine("GFED"))
            .setFlipped(flippedHorizontally)
